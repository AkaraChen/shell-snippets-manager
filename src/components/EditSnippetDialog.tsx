...
function EditSnippetDialogContent({ snippet, onOpenChange }: EditSnippetDialogContentProps) {
      ...
      <DialogContent className="sm:max-w-lg border-code-border">
        {snippet ? (
          <Suspense fallback={<LoadingFallback />}>
            <EditSnippetDialogContent snippet={snippet} onOpenChange={onOpenChange} />
          </Suspense>
        ) : (
          <LoadingFallback />
        )}
