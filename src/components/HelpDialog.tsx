...
function HelpDialogContent() {
	...
	const supportedShells = sortedShells.filter(
		(shell) => shell in SHELL_CONFIGS,
	);
						...
						>
							<div className="space-y-3 w-full min-w-0">
								...
								<p className="text-sm text-muted-foreground">
									Click the code block above to copy. If you'd
									like to{" "}
									<button
									...
									the generated shell scripts, they're saved
